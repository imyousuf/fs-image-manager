...
Tagged releases are built and published to GitHub Releases automatically by the
GitHub Actions release workflow when the maintainer pushes a `v*` tag. See
[deploy/README.md](../deploy/README.md) for install and self-update instructions.
